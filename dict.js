// 四级自习室 · 词典模块
// 点词翻译：先查「本课生词」→ 再查「内置四级词库」（约4694词）→ 可联网查英中词典
// 内置词库：四级大纲词表 + 现代高频词 + 各课生词，音标 + 中英双语释义；支持词形还原
...
const BUILTIN_DICT = {
  ...
  "accessible": "/əkˈsesəbl/ | 可到达的；易接近的",
  ...
  "biological": "/ˌbaɪəˈlɒdʒɪkl/ | 生物的；生物学的",
  ...
  "consistency": "/kənˈsɪstənsi/ | 一致性；连贯性",
  "consistent": "/kənˈsistənt/ | a. 坚持的，一贯的",
  "consolidate": "/kənˈsɒlɪdeɪt/ | 巩固；合并",
  ...
  "contractor": "/kənˈtræktə(r)/ | 承包人；承包商",
  ...
  "cultural": "/ˈkʌltʃərəl/ | adj. 文化的；人文的",
  ...
  "daytime": "/ˈdeɪtaɪm/ | n. 白天；日间",
  "dead": "/ded/ | a. 死的，无生命的",
  "deadline": "/ˈdedlaɪn/ | 截止时间；期限",
  ...
  "deliberately": "/dɪˈlɪbərətli/ | 故意地；审慎地",
  ...
  "disposable": "/dɪˈspəʊzəbl/ | 一次性的；用完即弃的",
  ...
  "dramatically": "/drəˈmætɪkli/ | 显著地；戏剧性地",
  ...
  "favor": "/ˈfeɪvə(r)/ | n. 帮助；恩惠 v. 支持；偏袒",
  ...
  "hippocampus": "/ˌhɪpəˈkæmpəs/ | 海马体（记忆相关脑区）",
  ...
  "homeland": "/ˈhəʊmlænd/ | 故乡；祖国",
  "hometown": "/ˌhəʊmˈtaʊn/ | n. 家乡；故乡",
  ...
  "intangible": "/ɪnˈtændʒəbl/ | 无形的；非物质的",
  ...
  "motivation": "/ˌməʊtɪˈveɪʃn/ | 动机；积极性",
  ...
  "notification": "/ˌnəʊtɪfɪˈkeɪʃn/ | 通知；告知",
  ...
  "overwhelmed": "/ˌəʊvəˈwelmd/ | 不知所措的；压垮的",
  "owe": "/əu/ | vt. 欠；应把…归功于",
  "owl": "/aul/ | n. 猫头鹰，枭",
  ...
  "personality": "/ˌpɜːsəˈnæləti/ | 性格；个性",
  ...
  "phubbing": "/ˈfʌbɪŋ/ | n. 低头族（只顾看手机而冷落身边人）",
  ...
  "realistic": "/ˌriːəˈlɪstɪk/ | 现实的；逼真的",
  ...
  "restorative": "/rɪˈstɒrətɪv/ | 恢复精力的；滋补的",
  ...
  "retiree": "/rɪˌtaɪəˈriː/ | 退休人员",
  "retreat": "/riˈtriːt/ | vi. (被迫)退却，后退",
  "return": "/riˈtəːn/ | vi. &n.回来，返回",
  "reunion": "/ˌriːˈjuːniən/ | n. 团聚；重聚",
  "reunite": "/ˌriːjuˈnaɪt/ | 团聚；重聚",
  ...
  "stressed": "/strest/ | 紧张的；有压力的",
  "stressful": "/ˈstresfl/ | 压力大的",
  ...
  "structured": "/ˈstrʌktʃəd/ | 有组织的；结构化的",
  ...
  "untreated": "/ˌʌnˈtriːtɪd/ | adj. 未经处理的",
  ...
  "worldwide": "/ˌwɜːldˈwaɪd/ | adj.&adv. 全世界的；遍及全球",
  "worm": "/wəːm/ | n. 虫，蠕虫",
...
// 常见不规则词形 → 原形（用于点词时还原：made→make、children→child 等）
const IRREGULAR = {
  made:'make', built:'build', hidden:'hide', taken:'take', held:'hold', said:'say',
  taught:'teach', shown:'show', spent:'spend', slept:'sleep', gone:'go', seen:'see',
  admitted:'admit', felt:'feel', kept:'keep', left:'leave', meant:'mean', met:'meet',
  paid:'pay', sent:'send', told:'tell', thought:'think', understood:'understand',
  won:'win', wrote:'write', grew:'grow', known:'know', knew:'know', drawn:'draw',
  driven:'drive', eaten:'eat', fallen:'fall', found:'find', flown:'fly', forgotten:'forget',
  forgiven:'forgive', given:'give', heard:'hear', led:'lead', lent:'lend', lost:'lose',
  ridden:'ride', risen:'rise', sat:'sit', sold:'sell', spoken:'speak', stood:'stand',
  swum:'swim', thrown:'throw', worn:'wear', broken:'break', chosen:'choose', begun:'begin',
  done:'do', drunk:'drink', frozen:'freeze', gotten:'get',
...
// 生成词形候选：原词 + 不规则还原 + 规则去后缀（复数/时态/ing/ed/ly/er/est）
function lemmaCandidates(w) {
  const cands = [w];
  if (IRREGULAR[w]) cands.push(IRREGULAR[w]);
  if (w.length <= 3) return cands;
  const rules = [
    [/ies$/, 'y'], [/ied$/, 'y'], [/ves$/, 'f'], [/es$/, ''], [/s$/, ''],
    [/ing$/, ''], [/ing$/, 'e'], [/ed$/, ''], [/ed$/, 'e'],
    [/ly$/, ''], [/est$/, ''], [/er$/, '']
  ];
  for (let i = 0; i < rules.length; i++) {
    const c = w.replace(rules[i][0], rules[i][1]);
    if (c !== w && c.length >= 2 && cands.indexOf(c) < 0) cands.push(c);
  }
  return cands;
}

// 本地查词：先本课生词，再内置词库（支持词形还原）
...
async function lookupOnline(word) {
  try {
    ...
    let zh = '';
    try {
      const t = await fetch('https://api.mymemory.translated.net/get?q=' + encodeURIComponent(word) + '&langpair=en|zh-CN');
      if (t.ok) {
        const td = await t.json();
        zh = (td.responseData && td.responseData.translatedText) || '';
        if (zh.toLowerCase() === word.toLowerCase()) zh = '';
      }
    } catch (e2) {}
    const meaning = '<div style="margin-bottom:6px">' + meanings + '</div>' +
      (zh ? '<div style="color:var(--ink-soft)">中文：' + zh + '</div>' : '');
    return { word: word, phonetic: phonetic, meaning: meaning, source: '在线词典（英中双语）' };
  } catch (err) {
    return null;
  }
}
